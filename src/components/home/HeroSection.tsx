      ...
      <div className="container-custom relative z-10 pt-24 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="inline-block text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-6 text-white bg-primary px-6 py-3 rounded-xl"
          >
            {t("title")}
          </motion.h1>
